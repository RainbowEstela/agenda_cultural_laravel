<x-layout-admin>
    <x-table.skeleton>
        ...
        <tr>
            ...
            <x-table.td>4452643634G</x-table.td>
            <x-table.td>miqota</x-table.td>
            <x-table.td>iniesta ruiz</x-table.td>
            <x-table.td>45</x-table.td>
            <x-table.td>miqota@gmail.com</x-table.td>
            <x-table.td>mi casa</x-table.td>
            <x-table.td>españa</x-table.td>
            <x-table.td>445264366</x-table.td>
            <x-table.td>
                <p><x-link.purple>Enlace</x-link.purple></p>
            </x-table.td>
            <x-table.td>encargada</x-table.td>
            <x-table.td>
